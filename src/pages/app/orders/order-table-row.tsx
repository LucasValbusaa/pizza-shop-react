...
import { OrderStatus, OrderStatusText } from '@/components/order-status'
...
export function OrderTableRow({ order }: OrderTableRowProps) {
  ...
  function updateOrderStatusOnCache(orderId: string, status: OrderStatusText) {
  ...
  return (
    <TableRow>
      ...
      <TableCell className="font-medium">
        <div className="flex items-center gap-2">{order.customerName}</div>
      </TableCell>
      <TableCell className="font-medium">
